...
/**
 * Exception thrown when a schema update is not compatible with the previous schema (or schemas) or
 * with existing datasets (if shared storage is used, for example).
 *
 * <p>
 *
 * @since 0.9.0
