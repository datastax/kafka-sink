...
/**
 * Exception thrown to indicate that there was a problem parsing or validating a schema, partition
 * strategy, or column mapping.
 *
 * <p>
 *
 * @since 0.14.0
...
public class ValidationException extends DatasetException {
  ...
  public static void check(boolean isValid, String message, Object... args) {
    if (!isValid) {
      ...
      throw new ValidationException(String.format(String.valueOf(message), (Object[]) argStrings));
    }
  }
}
