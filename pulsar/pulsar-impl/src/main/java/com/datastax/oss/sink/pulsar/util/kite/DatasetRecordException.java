 ...
 *
 * <p>When writing, this exception indicates that a record could not be written, but the writer is
 * still valid and ready to write other records.
 *
 * <p>When reading, this exception indicates that a record could not be built from record data, but
 * that reader is still valid and able to read other records.
 *
 * @since 0.18.0
 */
