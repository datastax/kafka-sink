...
@CCMConfig(ssl = true)
@Tag("medium")
class SslEndToEndCCMIT extends EndToEndCCMITBase<byte[]> {
  public SslEndToEndCCMIT(CCMCluster ccm, @SessionConfig(ssl = true) CqlSession session) {
    super(ccm, session, new BytesSink(true));
  }

  @Test
  void raw_bigint_value_without_hostname_validation() throws Exception {
  ...
  @Test
  void raw_bigint_value_with_hostname_validation() throws Exception {
    Map<String, Object> extras =
        ImmutableMap.<String, Object>builder()
            .put(SslConfig.PROVIDER_OPT, "JDK")
            .put(
  ...
  @Test
  void raw_bigint_value_with_openssl_without_hostname_validation() throws Exception {
    Map<String, Object> extras =
        ImmutableMap.<String, Object>builder()
  ...
  @Test
  void raw_bigint_value_openssl_with_hostname_validation() throws Exception {
    Map<String, Object> extras =
        ImmutableMap.<String, Object>builder()
            .put(SslConfig.PROVIDER_OPT, "OpenSSL")
            .put(
