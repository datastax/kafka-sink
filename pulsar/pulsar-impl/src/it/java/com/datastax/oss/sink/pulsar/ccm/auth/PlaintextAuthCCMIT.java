...
import com.datastax.oss.sink.config.AuthenticatorConfig.Provider;
...
@Tag("medium")
class PlaintextAuthCCMIT extends EndToEndCCMITBase<byte[]> {
  ...
  void should_insert_successfully_with_correct_credentials(Map<String, Object> extras)
      throws Exception {
