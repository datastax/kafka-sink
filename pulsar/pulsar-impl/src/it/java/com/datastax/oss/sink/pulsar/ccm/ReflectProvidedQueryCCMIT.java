...
class ReflectProvidedQueryCCMIT
  ...
  public ReflectProvidedQueryCCMIT(CCMCluster ccm, CqlSession session) {
  ...
  void should_insert_json_using_query_parameter() {
    ...
    sendRecord(mockRecord("mytopic", null, pulsarGenericJsonRecord(value), 1234, recordTimestamp));
  ...
  void should_fail_insert_json_using_query_parameter_with_deletes_enabled() {
    ...
    assertThatThrownBy(
            () ->
                sendRecord(
                    mockRecord(
                        "mytopic", null, pulsarGenericJsonRecord(value), 1234, recordTimestamp)))
  ...
  void should_update_json_using_query_parameter() {
    ...
    initConnectorAndTask(makeConnectorProperties("pkey=value.pkey, newitem=value.newitem", extras));
  ...
  void should_insert_struct_with_query_parameter() {
    ...
    sendRecord(mockRecord("mytopic", null, pulsarGenericAvroRecord(value), 1234, 153000987L));
  ...
  void should_use_query_to_partially_update_non_frozen_udt_when_null_to_unset() {
    ...
    sendRecord(mockRecord("mytopic", "98761234", pulsarGenericAvroRecord(value), 1234));
