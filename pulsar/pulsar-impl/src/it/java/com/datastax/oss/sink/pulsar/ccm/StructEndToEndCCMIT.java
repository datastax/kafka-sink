...
@Tag("medium")
class StructEndToEndCCMIT extends EndToEndCCMITBase<byte[]> {
  ...
  void struct_optional_field_with_default_value() {
    ...
    ((BytesSink) conn).setSchema("mytopic", null);
  }
  ...
  void multiple_records_multiple_topics() {
    ...
    Record<byte[]> record1 = mockRecord("mytopic", null, wornBytes(value1), 1234);
    Record<byte[]> record2 = mockRecord("mytopic", null, wornBytes(value2), 1235);
