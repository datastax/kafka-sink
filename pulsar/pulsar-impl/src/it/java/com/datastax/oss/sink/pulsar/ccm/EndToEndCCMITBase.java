...
public abstract class EndToEndCCMITBase<Coat> extends ITConnectorBase<Coat> {
  protected final boolean hasDateRange;
  protected final CCMCluster ccm;
  protected final CqlSession session;

  protected EndToEndCCMITBase(CCMCluster ccm, CqlSession session, Sink<Coat> sink) {
    super(ccm.getInitialContactPoints(), ccm.getBinaryPort(), ccm.getDC(1), session, sink);
    this.ccm = ccm;
