...
public class ConfigTransformerResult {
   ...
   *
   * <p>Modifying the transformed data that is returned does not affect the {@link ConfigProvider}
   * nor the original data that was used as the source of the transformation.
   *
  ...
  /**
   * Returns the TTL values (in milliseconds) returned from the ConfigProvider instances for a given
   * set of paths.
   *
