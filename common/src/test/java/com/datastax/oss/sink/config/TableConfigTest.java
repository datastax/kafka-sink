...
import static com.datastax.oss.sink.config.TableConfig.CL_OPT;
import static com.datastax.oss.sink.config.TableConfig.DELETES_ENABLED_OPT;
import static com.datastax.oss.sink.config.TableConfig.MAPPING_OPT;
import static com.datastax.oss.sink.config.TableConfig.QUERY_OPT;
import static com.datastax.oss.sink.config.TableConfig.TIMESTAMP_TIME_UNIT_OPT;
import static com.datastax.oss.sink.config.TableConfig.TTL_OPT;
import static com.datastax.oss.sink.config.TableConfig.TTL_TIME_UNIT_OPT;
