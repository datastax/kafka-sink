 ...
 */
package com.datastax.oss.sink.config;
...
import static com.datastax.oss.sink.config.CassandraSinkConfig.COMPRESSION_DEFAULT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.COMPRESSION_DRIVER_SETTING;
import static com.datastax.oss.sink.config.CassandraSinkConfig.COMPRESSION_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.CONCURRENT_REQUESTS_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.CONNECTION_POOL_LOCAL_SIZE;
import static com.datastax.oss.sink.config.CassandraSinkConfig.CONNECTION_POOL_LOCAL_SIZE_DEFAULT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.CONNECTION_POOL_LOCAL_SIZE_DRIVER_SETTING;
import static com.datastax.oss.sink.config.CassandraSinkConfig.CONTACT_POINTS_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.DC_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.IGNORE_ERRORS;
import static com.datastax.oss.sink.config.CassandraSinkConfig.JAVA_DRIVER_SETTINGS_LIST_TYPE;
import static com.datastax.oss.sink.config.CassandraSinkConfig.LOCAL_DC_DRIVER_SETTING;
import static com.datastax.oss.sink.config.CassandraSinkConfig.METRICS_HIGHEST_LATENCY_DEFAULT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.METRICS_HIGHEST_LATENCY_DRIVER_SETTINGS;
import static com.datastax.oss.sink.config.CassandraSinkConfig.METRICS_HIGHEST_LATENCY_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.METRICS_INTERVAL_DEFAULT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.PORT_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.QUERY_EXECUTION_TIMEOUT_DEFAULT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.QUERY_EXECUTION_TIMEOUT_DRIVER_SETTING;
import static com.datastax.oss.sink.config.CassandraSinkConfig.QUERY_EXECUTION_TIMEOUT_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.SECURE_CONNECT_BUNDLE_DRIVER_SETTING;
import static com.datastax.oss.sink.config.CassandraSinkConfig.SECURE_CONNECT_BUNDLE_OPT;
import static com.datastax.oss.sink.config.CassandraSinkConfig.SSL_OPT_PREFIX;
import static com.datastax.oss.sink.config.CassandraSinkConfig.withDriverPrefix;
import static com.datastax.oss.sink.config.SslConfig.PROVIDER_OPT;
import static com.datastax.oss.sink.config.TableConfig.MAPPING_OPT;
import static com.datastax.oss.sink.config.TableConfig.getTableSettingPath;
