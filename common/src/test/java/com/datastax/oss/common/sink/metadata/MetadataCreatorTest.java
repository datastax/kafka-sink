  ...
  void shouldCreateMetadataForStruct() throws IOException {
    ...
    AbstractSchema schema =
        new SchemaImpl(
            ...
            Arrays.asList(
                new FieldImpl("name", SchemaImpl.STRING_SCHEMA),
                new FieldImpl("age", SchemaImpl.INT32_SCHEMA)));
    AbstractStruct object = new StructImpl(schema).put("name", "Bobby McGee").put("age", 21);
