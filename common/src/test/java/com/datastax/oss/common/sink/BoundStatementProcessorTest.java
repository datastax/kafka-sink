...
class BoundStatementProcessorTest {
  ...
  void should_categorize_statement_in_statement_group() {
    ...
    AbstractSinkRecord record1 = new SinkRecordImpl("mytopic", 0, null, null, null, "value", 1234L);
    RecordAndStatement recordAndStatement1 = new RecordAndStatement(record1, "ks.mytable", bs1);

    AbstractSinkRecord record2 =
        new SinkRecordImpl("yourtopic", 0, null, null, null, "value", 1234L);
        ...
        new Thread(
            () -> {
              for (int i = 0; i < totalNumberOfRecords; i++) {
                AbstractSinkRecord record =
                    new SinkRecordImpl("mytopic", i, null, null, null, i, i);
  ...
  private void addSinkRecord(
    ...
    AbstractSinkRecord record =
        new SinkRecordImpl(topic, 1, null, kafkaKey, null, kafkaValue, 1234);
    BoundStatement statement = mock(BoundStatement.class);
  ...
  private AbstractSinkTask mockCassandraSinkTask() {
    ...
    AbstractSinkTask sinkTask = mock(AbstractSinkTask.class);
