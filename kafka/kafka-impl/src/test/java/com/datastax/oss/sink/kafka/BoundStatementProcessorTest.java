...
class BoundStatementProcessorTest {
  ...
  void should_categorize_statement_in_statement_group() {
    ...
    RecordAndStatement<SinkRecord> recordAndStatement1 =
        new RecordAndStatement<>(record1, "ks.mytable", bs1);

    SinkRecord record2 = new SinkRecord("yourtopic", 0, null, null, null, "value", 1234L);
    RecordAndStatement<SinkRecord> recordAndStatement2 =
        new RecordAndStatement<>(record2, "ks.mytable", bs1);

    Map<String, Map<ByteBuffer, List<RecordAndStatement<SinkRecord>>>> statementGroups =
        new HashMap<>();

    // We don't care about the args to the constructor for this test.
    BoundStatementProcessor<SinkRecord> statementProcessor =
    ...
    List<RecordAndStatement<SinkRecord>> result1 =
        statementProcessor.categorizeStatement(statementGroups, recordAndStatement1);
    List<RecordAndStatement<SinkRecord>> result2 =
    ...
    Map<ByteBuffer, List<RecordAndStatement<SinkRecord>>> batchGroups =
    ...
    List<RecordAndStatement<SinkRecord>> batchGroup = batchGroups.get(routingKey);
  ...
  void should_create_batches_of_expected_size(
    ...
    // given
    BlockingQueue<RecordAndStatement<SinkRecord>> recordAndStatements = new LinkedBlockingQueue<>();
    BoundStatementProcessor<SinkRecord> statementProcessor =
    ...
    Consumer<List<RecordAndStatement<SinkRecord>>> mockConsumer =
  ...
  private RecordProcessor<SinkRecord, Header> mockCassandraSinkTask() {
